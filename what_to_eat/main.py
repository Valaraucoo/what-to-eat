...
from what_to_eat import config, controllers, validators, version_callback
...
def ls(
    ...
    profile_name: Optional[str] = typer.Option(  # noqa: U007
    ...
    limit: Optional[int] = typer.Option(  # noqa: U007
        None, "--limit", "-l", help="Limit results"
    ),
) -> None:
    ...
    return controllers.items_controller(
        items, profile, query, tag, sort, ordering, limit
    )
